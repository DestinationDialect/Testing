...
export default function ZooScenario() {
  ...
  return (
    <SafeAreaView style={zooStyles.container}>
      <Modal visible={isVisible} transparent={true}>
        <View style={zooStyles.modalOverlay}>
          <View
            style={[zooStyles.modalView, darkMode && zooStyles.darkModalView]}
          >
            <Text style={zooStyles.score}>
              You got {averageScore / 30} stars!
            </Text>
            <Pressable
              onPress={() => setVisible(false)}
              style={[
                zooStyles.closeButton,
                darkMode && zooStyles.darkCloseButton,
              ]}
            >
              <Text
                style={[
                  zooStyles.buttonText,
                  darkMode && zooStyles.darkButtonText,
                ]}
              >
                Review Lesson
              </Text>
      ...
      <ImageBackground
        ...
        style={zooStyles.imageBackground}
        resizeMode="cover"
      >
        <Pressable onPress={() => navigation.replace("Route")}>
          <Image
            style={zooStyles.backButtonIcon}
      ...
      <View style={[zooStyles.overlay, darkMode && zooStyles.darkOverlay]}>
                ...
                <Pressable key={index} onPress={() => checkAnswer(option)}>
                  <Text
                    style={[
                      ...
                      isCorrect
                        ? [
                            zooStyles.correctAnswer,
                            darkMode && zooStyles.darkCorrectAnswer,
                          ]
                        : [zooStyles.option, darkMode && zooStyles.darkOption],
                    ]}
                  >
                    {option}
                  </Text>
        ...
        <Pressable
          ...
          style={[zooStyles.nextButton, darkMode && zooStyles.darkNextButton]}
        >
          <Text
            style={[zooStyles.buttonText, darkMode && zooStyles.darkButtonText]}
          >
            Next Question
          </Text>
        </Pressable>
...
const zooStyles = StyleSheet.create({
  container: {
    flex: 1,
